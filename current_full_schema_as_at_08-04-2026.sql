...
CREATE TABLE public.mobile_push_campaigns (
  ...
  action_url text,
  cta_label text,
  category_id text NOT NULL DEFAULT 'mobile_campaign'::text,
  status text NOT NULL DEFAULT 'draft'::text CHECK (status = ANY (ARRAY['draft'::text, 'sending'::text, 'sent'::text, 'failed'::text, 'cancelled'::text])),
  metadata jsonb NOT NULL DEFAULT '{}'::jsonb,
  created_by uuid,
  ...
  created_at timestamp with time zone NOT NULL DEFAULT now(),
  updated_at timestamp with time zone NOT NULL DEFAULT now(),
  CONSTRAINT mobile_push_campaigns_pkey PRIMARY KEY (id),
  CONSTRAINT mobile_push_campaigns_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id)
);
CREATE TABLE public.mobile_push_campaign_recipients (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  campaign_id uuid NOT NULL,
  user_id uuid NOT NULL,
  status text NOT NULL DEFAULT 'pending'::text CHECK (status = ANY (ARRAY['pending'::text, 'sent'::text, 'failed'::text, 'read'::text, 'opened'::text])),
  error_message text,
  sent_at timestamp with time zone,
  ...
  created_at timestamp with time zone NOT NULL DEFAULT now(),
  updated_at timestamp with time zone NOT NULL DEFAULT now(),
  CONSTRAINT mobile_push_campaign_recipients_pkey PRIMARY KEY (id),
  CONSTRAINT mobile_push_campaign_recipients_campaign_id_fkey FOREIGN KEY (campaign_id) REFERENCES public.mobile_push_campaigns(id),
  CONSTRAINT mobile_push_campaign_recipients_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id)
);
CREATE TABLE public.cashback_programs (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  name character varying NOT NULL,
  description text,
  program_type character varying NOT NULL CHECK (program_type::text = ANY (ARRAY['first_ride'::character varying, 'spin_wheel'::character varying, 'referral'::character varying, 'special'::character varying]::text[])),
...
CREATE TABLE public.user_cashback_rewards (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  user_id uuid NOT NULL,
  ...
  status character varying NOT NULL DEFAULT 'earned'::character varying CHECK (status::text = ANY (ARRAY['earned'::character varying, 'used'::character varying, 'expired'::character varying, 'cancelled'::character varying]::text[])),
  ...
  CONSTRAINT user_cashback_rewards_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id),
...
CREATE TABLE public.spin_wheel_results (
  ...
  user_id uuid NOT NULL,
  program_id uuid NOT NULL,
  spin_result character varying NOT NULL CHECK (spin_result::text = ANY (ARRAY['1_percent'::character varying, '2_percent'::character varying, '3_percent'::character varying, '4_percent'::character varying, '5_percent'::character varying, 'try_again'::character varying]::text[])),
  displayed_result character varying NOT NULL CHECK (displayed_result::text = ANY (ARRAY['1_percent'::character varying, '2_percent'::character varying, '3_percent'::character varying, '4_percent'::character varying, '5_percent'::character varying, '6_percent'::character varying, '7_percent'::character varying, '8_percent'::character varying, '9_percent'::character varying, '10_percent'::character varying, 'try_again'::character varying]::text[])),
  discount_percentage numeric NOT NULL CHECK (discount_percentage >= 1::numeric AND discount_percentage <= 5::numeric),
  discount_amount numeric,
  status character varying NOT NULL DEFAULT 'won'::character varying CHECK (status::text = ANY (ARRAY['won'::character varying, 'used'::character varying, 'expired'::character varying, 'cancelled'::character varying]::text[])),
  ...
  CONSTRAINT spin_wheel_results_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id),
...
CREATE TABLE public.user_cashback_stats (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  user_id uuid NOT NULL UNIQUE,
  total_rides_completed integer DEFAULT 0,
  ...
  CONSTRAINT user_cashback_stats_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id)
);